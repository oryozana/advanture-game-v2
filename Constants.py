...
# Menu:
MENU_ROWS = int(SCREEN_WIDTH // SCALE)
MENU_COLS = int(SCREEN_HEIGHT // SCALE)
MENU_TILE_SIZE = 20
FIRST_RECT_X_POS = 60
...
# End screen:
END_SCREEN_ROWS = int(SCREEN_WIDTH // SCALE)
END_SCREEN_COLS = int(SCREEN_HEIGHT // SCALE)
END_SCREEN_CUBE_SCALE = SCALE * 10
END_SCREEN_CUBE_X_SPACE = SCALE * 6 + END_SCREEN_CUBE_SCALE
END_SCREEN_FIRST_CUBE_X = (MAP_COLS // 2) * SCALE
END_SCREEN_FIRST_CUBE_Y = FLOOR_HEIGHT * SCALE - END_SCREEN_CUBE_SCALE + 1 * SCALE
END_SCREEN_HEART_SCALE = SCALE * 4
END_SCREEN_HEART_X = (MAP_COLS // 2) * SCALE + (END_SCREEN_CUBE_X_SPACE // 2) + END_SCREEN_HEART_SCALE - 1 * SCALE
END_SCREEN_HEART_Y = FLOOR_HEIGHT * SCALE - END_SCREEN_HEART_SCALE - 2 * SCALE
...
GRAVITY = 1
X_POSITION = 1
Y_POSITION = (CELLING_HEIGHT + FLOOR_HEIGHT) // 2 - 8
CHARACTER_HEIGHT = 20
CHARACTER_WIDTH = 20
...
SUPPORT_SHELF_HEIGHT = (CELLING_HEIGHT + FLOOR_HEIGHT) // 2
